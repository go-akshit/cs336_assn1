...
def get_args():
    ...
    parser.add_argument("--input_train_file", type=str, default='./tests/fixtures/tinystories_sample.txt', help="Path to the input file")
    parser.add_argument("--input_val_file", type=str, default='./tests/fixtures/tinystories_sample.txt', help="Path to the input file")
    ...
    parser.add_argument("--num_heads", type=int, default=2, help="Number of heads in the transformer")
